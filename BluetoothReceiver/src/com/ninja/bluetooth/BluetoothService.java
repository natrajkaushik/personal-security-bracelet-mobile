...
public class BluetoothService {
	...
	private static final String NAME_SECURE = "BluetoothReceiver";
	...
	/**
	 * Start the receiver service. Specifically start AcceptThread to begin a
	...
	private class AcceptThread extends Thread {
		...
		public AcceptThread(boolean secure) {
			...
			Log.d(TAG, "service listening for incoming bluetooth connections");
			mmServerSocket = tmp;
		}
